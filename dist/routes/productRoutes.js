...
const pc = __importStar(require("../controllers/productController"));
 ...
 */
router.post("/", authMiddleware_1.protect, uploadMiddleware_1.uploadProductImages.array("images", 10), pc.createProduct);
/**
 * @swagger
 * /products/{id}:
 *   put:
 ...
 */
router.put("/:id", authMiddleware_1.protect, uploadMiddleware_1.uploadProductImages.array("images", 10), pc.updateProduct);
/**
 * @swagger
 * /products/{id}:
 *   delete:
 ...
 */
router.delete("/:id", authMiddleware_1.protect, pc.deleteProduct);
